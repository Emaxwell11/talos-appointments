...
<head>
    ...
    <?php endif; ?>
<style>.wrapper, .container {display:block !important;} ._failed{ border-bottom: solid 4px red !important; }
...
<body>
    ...
    <div class="main-wrapper">
        ...
        <?php if (isset($page) && ($page == 'Company' || $page == 'PayLinks')): ?>
            <header class="<?php if (isset($page_title) && ($page_title == 'Company Home' || $page_title == 'Payment Link Customer')){echo 'position-absolute';} ?> left-0 top-0 w-100">
                <div class="container">
                    <nav class="navbar navbar-expand-lg navbar-light py-3">
                        ...
                        <!-- Menu -->
                        <div id="navbarContent" class=" <?php if (isset($page_title) && $page_title == 'Company Home'){echo 'collapse navbar-collapse company mt-2';} else{ echo 'd-none'; } ?>">
