                  ...
                  <div class="col-md-3">
                    <div class="card-body">
                      <ul class="nav nav-pills flex-column" id="myTab" role="tablist">
                        ...
                        <li class="nav-item">
                          <a class="nav-link" id="appearance-tab" data-toggle="tab" href="#appearance" role="tab" aria-controls="appearance" aria-selected="false"><i class="fas fa-paint-brush mr-1"></i> <?php echo trans('appearance') ?> <span class="right badge badge-danger pull-rights">New</span></a>
                        </li>
                        <li class="nav-item">
                    ...
                    <form method="post" enctype="multipart/form-data" action="<?php echo base_url('admin/settings/update') ?>" role="form" class="form-horizontal pl-20">
                      <div class="tab-content custom card-body" id="myTabContent">
                        ...
                        <div class="tab-pane fade" id="social" role="tabpanel" aria-labelledby="social-tab">
                            ...
                            <div class="form-group">
                              <label><?php echo trans('google-analytics') ?></label>
