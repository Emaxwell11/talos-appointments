    ...
    <nav class="mt-4">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <?php if (is_admin()): ?>
          ...
          <li class="nav-item has-treeview <?php if(isset($page) && $page == "Settings"){echo "menu-open";} ?>">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo base_url('admin/Area/city') ?>" class="nav-link <?php if(isset($page_title) && $page_title == "Country"){echo "active";} ?>">
                  <i class="lni lni-layout nav-icon"></i>
                  <p>Cities</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a class="nav-link <?php if(isset($page_title) && $page_title == "Testimonial"){echo "active";} ?>" href="<?php echo base_url('admin/testimonial') ?>">
              <i class="nav-icon far fa-comment-dots"></i> <p><?php echo trans('testimonials') ?> <span class="right badge badge-danger mt--3">New</span></p> 
            </a>
          </li>
        ...
        <?php if (is_user()): ?>
          ...
          <?php if ($ci->business->category==0){ ?>
            <li class="nav-item">
              <a class="nav-link <?php if(isset($page) && $page == "Loan_Managemant"){echo "active";} ?>" href="<?php echo base_url('admin/LoanManagement') ?>">
                <i class="nav-icon lni lni-coin"></i> <p>Loan Management</p>
              </a>
            </li>

            <li class="nav-item">
              <a class="nav-link <?php if(isset($page) && $page == "Loan_Managemant_report"){echo "active";} ?>" href="<?php echo base_url('admin/LoanManagement/report') ?>">
                <i class="nav-icon lni lni-coin"></i> <p>Past Due Obligation (PDO)</p>
              </a>
            </li>
          <?php } ?>
            ...
            <li class="nav-item has-treeview <?php if(isset($page) && $page == "Settings"){echo "menu-open";} ?>">
              ...
              <li class="nav-item">
                <a class="nav-link <?php if(isset($page_title) && $page_title == "Transactions"){echo "active";} ?>" href="<?php echo base_url('admin/payment/customer_transactions') ?>">
                  <i class="nav-icon lni lni-investment"></i> <p><?php echo trans('transactions') ?> <span class="right badge badge-danger mt--3">New</span></p>
                </a>
              </li>
              ...
              <?php if (check_feature_access('pay-links') == TRUE): ?>
                <li class="nav-item">
                  <a class="nav-link <?php if(isset($page_title) && $page_title == "Payment Links"){echo "active";} ?>" href="<?php echo base_url('admin/paylinks') ?>">
                    <i class="nav-icon lni lni-link"></i> <p><?php echo trans('pay-links') ?></p>
                  </a>
                </li>
              <?php endif; ?>
              ...
              <li class="nav-item">
                <a class="nav-link <?php if(isset($page_title) && $page_title == "Reports"){echo "active";} ?>" href="<?php echo base_url('admin/reports') ?>">
                  <i class="nav-icon far fa-chart-bar"></i> <p><?php echo trans('reports') ?> <span class="right badge badge-danger mt--3">New</span></p>
                </a>
              </li>
