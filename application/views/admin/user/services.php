                      ...
                      <tbody>
                        ...
                        <tr id="row_<?php echo html_escape($service->id); ?>">
                          ...
                          <td>
                            ...
                            <p class="p-0 m-0">
                              <span class="small"><?php if($service->duration == -1){echo "Unlimited";}else{echo html_escape($service->duration).' '.trans($service->duration_type);} ?></span>
                            </p>
                          </td>
