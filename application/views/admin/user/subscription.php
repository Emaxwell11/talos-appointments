                            ...
                            <li class="nav-item active">
                                <a href="#" class="nav-link">
                                    <?php echo trans('price') ?> <span
                                        class="badge bg-secondary-soft float-right"><?php if(settings()->curr_locate == 0){echo settings()->currency_symbol;} ?><?php echo number_format($user->amount, settings()->num_format) ?>
