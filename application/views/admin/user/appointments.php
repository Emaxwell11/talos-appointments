                ...
                <div class="card-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-7 mt-4">
                          ...
                          <div class="form-group staff_area" style="display: none;">
                          ...
                          <div class="form-group mb-4">
                            ...
                            <div class="input-group">
                              <input type="text" name="date" id="datepickers" class="form-control" required placeholder="<?php echo trans('booking-date') ?>" autocomplete="off" value="<?php if (isset($appointment[0]['date'])){echo html_escape($appointment[0]['date']);} ?>" required>
                            ...
                            <?php $a=1; foreach ($appointments as $appointment): ?>
                                <tr class="default" id="row_<?php echo html_escape($appointment->id) ?>">
                                    ...
                                    <td>
                                      <div class="d-flex">
                                        <div class="mr-3">
                                          <img class="img-circle mr-2" width="40px" src="<?php echo base_url($appointment->customer_thumb) ?>"> <?php echo html_escape($appointment->customer_name) ?>
                                        </div>
                                      </div>
                                    </td>
                                    ...
                                    <td>
                                      ...
                                      <p class="fs-14 mb-0">
                                          ...
                                          <?php if ($check_payment == true): ?>
                                            <span class="text-success fs-12"><i class="fas fa-check-circle"></i> <?php echo trans('paid') ?></span>
                                          <?php else: ?>
                                            <?php if ($appointment->price != 0): ?>
                                              <span class="text-warning fs-12"><i class="far fa-clock"></i> <?php echo trans('pending') ?></span>
                                            <?php endif; ?>
                                          <?php endif; ?>
                                      </p>
                                      ...
                                      <div class="full-sub-table">
                                        ...
                                        <dl class="info-wrapper">
                                          ...
                                          <?php if (!empty($appointment->zoom_link)): ?>
                                             <dt><?php echo trans('zoom-meeting') ?>: <?php echo trans('yes') ?></dt>
                                          <?php else: ?>
                                             <dt><?php echo trans('zoom-meeting') ?>: <?php echo trans('yes') ?></dt>
                                          <?php endif ?>
                                        </dl>
