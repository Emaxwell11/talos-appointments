...
{   
    ...
    if(!function_exists('get_staffs_asign_locations')){
    	...
    	function get_staffs_asign_locations($location, $sub){        

    		$ci = get_instance();

    		$response = $ci->admin_model->get_staffs_asign_locations($location, $sub);
    ...
    if(!function_exists('check_time')){
    	...
    	function check_time($time, $date){        
    		...
    		$response = $ci->admin_model->check_time($time, $date);
    ...
    if(!function_exists('check_staff_time')){
    	...
    	function check_staff_time($time, $date){        
    		...
    		$response = $ci->admin_model->check_staff_time($time, $date);
    ...
    if(!function_exists('check_break')){
    	...
    	function check_break($start, $end, $date){        

    		$ci = get_instance();

    		$response = $ci->admin_model->check_break($start, $end, $date);
