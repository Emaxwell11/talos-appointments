...
$route['confirm_payment'] = 'checkout/confirm_payment]';
$route['confirm_payment/return'] = 'checkout/return';
// $route['checkout/(:any)'] = 'checkout/index/$1';
$route['checkout-payment/success'] = 'checkout/success';
$route['checkout-payment/failed'] = 'checkout/failed';
$route['stripePost']['post'] = "checkout/stripePost";
$route['create_checkout_session'] = "checkout/create_checkout_session";
$route['element/(:any)'] = "checkout/element/$1";
$route['element_return'] = "checkout/confirm_payment";
$route['return'] = "checkout/return";
